...
public class Teleport {
	public Teleport(Supernatural supernatural, Constants constants, Player p) {
		if(supernatural.getTeleportLocation(p) != null) {
			supernatural.setCooldown(p.getUniqueId(), "Teleport", supernatural.getConfig().getInt("Classes.Vampire.ActiveAbilities.Teleport.Cooldown"));
			supernatural.setMagic(p, supernatural.getMagic(p) - supernatural.getConfig().getInt("Classes.Vampire.ActiveAbilities.Teleport.Magic-Cost"), false);
			p.setFoodLevel(p.getFoodLevel() - supernatural.getConfig().getInt("Classes.Vampire.ActiveAbilities.Teleport.Food-Cost"));
			p.setHealth(p.getHealth() - supernatural.getConfig().getInt("Classes.Vampire.ActiveAbilities.Teleport.Health-Cost"));
