...
public class SetTeleportLocation {
	public SetTeleportLocation(Supernatural supernatural, Constants constants, Player p) {
		...
		supernatural.setMagic(p, supernatural.getMagic(p) - supernatural.getConfig().getInt("Spells.Vampire.SetTeleportLocation.Magic-Cost"), false);
		p.setFoodLevel(p.getFoodLevel() - supernatural.getConfig().getInt("Spells.Vampire.SetTeleportLocation.Food-Cost"));
		p.setHealth(p.getHealth() - supernatural.getConfig().getInt("Spells.Vampire.SetTeleportLocation.Health-Cost"));
